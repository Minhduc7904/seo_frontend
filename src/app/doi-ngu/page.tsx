...
export default function DoiNguPage() {
    return (
        <div className="space-y-8">
            <PagePoster
                title="Đội ngũ"
                imageSrc="/images/doi_ngu/poster.png"
            ...
            <div className="space-y-4">
                ...
                <p className="text-base leading-7 text-slate-700">
                    Đây là trang cơ bản giới thiệu đội ngũ. Hồ sơ giảng viên, chuyên môn và thành tựu sẽ được hiển thị chi tiết ở phiên bản tiếp theo.
                </p>
            </div>
        </div>
    );
