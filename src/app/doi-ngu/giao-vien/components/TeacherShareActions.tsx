...
type TeacherShareActionsProps = {
    title: string;
};

export default function TeacherShareActions({ title }: TeacherShareActionsProps) {
    ...
    return (
        <div className="space-y-3 rounded-2xl border border-slate-200 bg-white p-4">
            <h2 className="text-base font-bold text-blue-900">Chia sẻ hồ sơ</h2>
